...
<div id="Body"
			...
			<table align="center" cellpadding="4" cellspacing="3" border="1">
				...
				<%
					...
					try {
						...
						ResultSet rs = s.executeQuery("SELECT * FROM bilete");
						while (rs.next()) {
				%>
				<tr>
					...
					<td><%=rs.getString("BileteVandute")%></td>
        ...
        <form method="post" action="IBilete">
            <table align="center">
                ...
                <tr>
                    <td>Bilete Vandute</td>
                    <td><input type="text" name="BileteVandute"></td>
                </tr>
        ...
        <form method="post" action="DBilete">
            <table align="center">
        ...
        <form method="post" action="CBilete">
            <table align="center">
 				<tr>
                    <td>Id</td>
                    <td><input type="text" name="Id"></td>
